...
/** `?types=1` returns the room-type taxonomy instead of the room list — kept on this same route rather than a new file, since both are simple provider-authenticated GETs the "Add a room" form needs together. */
